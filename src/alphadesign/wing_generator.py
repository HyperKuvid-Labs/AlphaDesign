...
try:
    from .generation_scripts.f1_multi_flap_system_gen import F1FrontWingMultiElementGenerator
    from .generation_scripts.f1_main_wing_geometry import F1FrontWingMainElementGenerator
    from .generation_scripts.f1_y250_gen import F1FrontWingY250CentralStructureGenerator
    from .generation_scripts.f1_endplate_generator import F1FrontWingEndplateGenerator
